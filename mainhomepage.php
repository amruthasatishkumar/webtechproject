...
<div class="statusbox">
 <ul class="statusboxul">
  <li class="statusboxli"><a class="active" href="mainhomepage.php">HOME</a></li>
...
<div class="hero-image">
  <div class="hero-text" style="border:5px; border-style:solid; border-color:black; padding: 1em;">
    <h1 style="font-size:50px">Corners Of India</h1>
    <button onclick=lfunction() type="button">Get Free Iternary</button>
    <br>
    <br>
...
<ul style="list-style-type:square">
 ...
 <li><a href="AndhraPradesh/AndhraPradesh.php">Andra Pradesh</a></li>
...
<div class="middle">
          ...
          <div class="cont">
            <ul style="list-style-type:square">
               ...
               <li><a href="Maharashtra/MP.php">Maharashtra</a></li>
            </ul>
          </div>
</div>
...
<ul style="list-style-type:square">
 ...
 <li><a href="ArunachalPradesh/arunachal.php">Arunachal Pradesh</a></li>
...
function lfunction()
{
  alert("Please login to get your free iterinary");
}
...
<br>
<br>
<div class="Signupbox"  style="border:5px; border-style:solid; border-color:black; padding: 1em;">
  <center>
    <br>
  <blockquote class="Stext"><strong>Plan Your Trip with Us <Strong> </blockquote>
  <button onclick="location.href='register.php'" style="border:5px; border-style:solid; border-color:white; padding: 1em;"> SIGN UP NOW </button>
  </center>
  <br>
</div>
<br>
